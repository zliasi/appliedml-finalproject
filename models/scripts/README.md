...
- `04-submit-evaluate.sh` - submit test-set eval as a GPU job (runs `workers/evaluate.py`): per-model metrics, parity/error plots, and a ranked summary merging any baselines
